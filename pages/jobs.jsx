...
import jobsImg from "../public/projects/jobs.png";
    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] z-10 p-2 text-white  dark:text-gray-500">
          <h2 className="py-2">Job listing Application</h2>
          <h3>React Native</h3>
        </div>
      </div>
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8  dark:text-gray-500">
        <div className="col-span-4">
          ...
          <Link
            href="exp://exp.host/@kwekss/jobs?release-channel=default"
            target={"_blank"}
          ...
          <Link
            href="https://github.com/kwekss/jobs"
            target={"_blank"}
            rel={"noopener norefferer"}
          >
